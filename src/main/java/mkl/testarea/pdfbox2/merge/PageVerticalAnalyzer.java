 ...
 * </a>
 * <p>
 * This {@link PDFGraphicsStreamEngine} looks for vertical sections of use in a page.
 * </p>
 * <p>
 * Beware, this is a mere proof of concept. Especially {@link #curveTo(float, float, float, float, float, float)}
 * needs to be improved, see the comment there.
 * </p>
 * <p>
 * This class corresponds to the itext5 test area class with the same name,
